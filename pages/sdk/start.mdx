...
## Goal: Read Tokenbound Account for any NFT
The following Tutorial is uses <a href="https://wagmi.sh/cli/create-wagmi" target="_blank">`create-wagmi` ↗️</a> boilerplate

![demo image](https://i.imgur.com/z7a17B3.png)

<Cards>
<Card
    icon={<BsWindowFullscreen style={{placeSelf: "center"}} />}
    title="Demo ↗️"
    href="https://tb-sdk-demo-create-wagmi.vercel.app/"
  />
  <Card
    icon={<BiCodeAlt style={{placeSelf: "center"}} />}
    title="Codebase ↗️"
    href="https://github.com/anggxyz/tb-sdk-demo-create-wagmi"
  />
</Cards>
<Steps>
### Install dependencies
  ...
  ```
### Create form to input NFT contract address and token Id
