...
If your application was created using the **standard legacy V2 account implementation** (see 0.2.0: [V2 →](https://docs.tokenbound.org/contracts/deployments)), you'll need to instruct the `TokenboundClient` to use it by specifying the `TBVersion`
