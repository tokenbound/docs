...
<Tabs items={["create-wagmi", "create-t3"]}>
<Tab>
  The following Tutorial uses <a href="https://wagmi.sh/cli/create-wagmi" target="_blank">`create-wagmi` ↗️</a> boilerplate
  <br/>
  <Image src="https://i.imgur.com/z7a17B3.png" width="650" height="150" alt="demo screenshot" />
  <br/>
  <Cards>
    <Card
...
<Tab>
  The following Tutorial uses <a href="https://create.t3.gg/" target="_blank">`create-t3` ↗️</a> boilerplate
</Tab>
