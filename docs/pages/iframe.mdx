...
<Steps>
  <Step title="Fork and clone the iframe repo">
    ```bash copy
  ...
  <Step title="Create an Alchemy account and API key">
  ...
  <Step title="Create a Graph studio account and API key">
  ...
  <Step title="Use in your custom api endpoint to fetch your NFT's media">
  ...
  <Step title="Host your application">
